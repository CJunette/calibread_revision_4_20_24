...
from funcs.visualize_calibrate_and_gradient_descent import visualize_cali_grad_process, visualize_all_subject_cali_grad_result, visualize_all_subject_cali_grad_process
...
if __name__ == '__main__':
    ...
    # visualize_cali_grad_process(7, 1, 3)
    # visualize_all_subject_cali_grad_process(6, 1)
    # visualize_all_subject_cali_grad_result(6, 1)
